...
namespace Tall\Http\Livewire\Admin\Operacional\Tenants;
...
class ShowComponent extends FormComponent
{
    ...
    {
        return \App\Models\Role::query()->where('tenant_id',data_get($this->data,'tenant.stepTenant'))->get();
    }
    
    public function getMenusProperty()
    {
        return \App\Models\Menu::query()->where('tenant_id',data_get($this->data,'tenant.stepTenant'))->get();
    }
    ...
    {
        return 'tall::admin.operacional.tenants.show';
    }
}
