...
namespace Tall\Http\Livewire\Admin\Operacional\Cms\Inputs\Attributes;

use Tall\Http\Livewire\FormComponent;
use Tall\Models\InputAttribute;
...
class EditComponent extends FormComponent
{
    ...
    public function mount(InputAttribute $item, $options, $name)
    {
    ...
    {
        return 'tall::admin.operacional.cms.inputs.attributes.edit';
    }
}
