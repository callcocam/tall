<div class="flex items-center px-4 py-4 sm:px-6">
    ...
    <div class="flex flex-col md:flex-row gap-1" x-data="{ confirm: false }">
        <!-- Heroicon name: mini/chevron-right -->
        <div x-show="confirm">
            <x-button x-on:click='confirm= false' label="CANCEL" icon="refresh" black />
            <x-button wire:click='delete' label="DELETE" icon="trash" gray />
        </div>
        <div x-show="!confirm">
            <x-button wire:click='submit' green label="EDIT" icon="pencil" />
            <x-button x-on:click='confirm= true' label="DELETE" icon="trash" red />
        </div>
    </div>
</div>
