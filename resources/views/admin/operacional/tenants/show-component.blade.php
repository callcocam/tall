                                        ...
                                        <div class="mt-2 text-sm text-gray-500">
                                            <fieldset class="space-y-5">
                                                @switch(data_get($data,'tenant.step'))
                                                    @case(0)
                                                        @include('tall::admin.operacional.tenants.start')
                                                    @break

                                                    @case(1)
                                                        @include('tall::admin.operacional.tenants.tenant')
                                                    @break

                                                    @case(2)
                                                        @include('tall::admin.operacional.tenants.access')
                                                    @break

                                                    @case(3)
                                                        @include('tall::admin.operacional.tenants.menus')
                                                    @break

                                                    @default
                                                        @include('tall::admin.operacional.tenants.end')
                                                @endswitch
                                            </fieldset>
                                        </div>
